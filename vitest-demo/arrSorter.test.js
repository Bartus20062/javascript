...
import { bubbleSort, selectionSort, insertionSort, quickSort } from "./arrSorter.js"; // zmień ścieżkę, jeśli plik nazywa się inaczej

const testCases = [
  { input: [3, 1, 2], expected: [1, 2, 3] },
  { input: [5, 3, 8, 1, 2], expected: [1, 2, 3, 5, 8] },
  { input: [1, 8, 6, 2, 3, 0], expected: [0, 1, 2, 3, 6, 8] },
  { input: [], expected: [] }, // Pusta tablica
  { input: [42], expected: [42] }, // Jeden element
  { input: [-3, -1, -2, 5, 4], expected: [-3, -2, -1, 4, 5] }, // Liczby ujemne
];
